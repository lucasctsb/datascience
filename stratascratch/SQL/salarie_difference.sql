...
# Databases are "db_employee" and "db_dept". Database "db_employee" has the following columns: "id", "first_name", "last_name", "salary" and "department_id". Database "db_dept" has the columns "id" and "department".
